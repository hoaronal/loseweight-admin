...
import com.loseweight.dto.mapper.TicketMapper;
import com.loseweight.dto.mapper.TripMapper;
import com.loseweight.dto.mapper.TripScheduleMapper;
...
import com.loseweight.model.bus.*;
import com.loseweight.model.user.User;
import com.loseweight.repository.bus.*;
import com.loseweight.util.RandomStringUtil;
...
public class BusReservationServiceImpl implements BusReservationService {
    ...
    public AgencyDto updateAgency(AgencyDto agencyDto, BusDto busDto) {
        ...
        if (agency != null) {
            if (busDto != null) {
                ...
                throw exceptionWithId(EntityType.BUS, ExceptionType.DUPLICATE_ENTITY, 2, busDto.getCode(), agencyDto.getCode());
            } else {
        ...
        throw exceptionWithId(EntityType.AGENCY, ExceptionType.ENTITY_NOT_FOUND, 2, agencyDto.getOwner().getEmail());
    }
        ...
        if (trip.isPresent()) {
            ...
            if (tripSchedule.isPresent()) {
                ...
                if (createSchedForTrip) { //create the schedule
                    ...
                    throw exceptionWithId(EntityType.TRIP, ExceptionType.ENTITY_NOT_FOUND, 2, tripDto.getId().toString(), tripDate);
                }
            }
        }
    ...
    public TicketDto bookTicket(TripScheduleDto tripScheduleDto, UserDto userDto) {
        ...
        if (user != null) {
            ...
            throw exceptionWithId(EntityType.TRIP, ExceptionType.ENTITY_NOT_FOUND, 2, tripScheduleDto.getTripId().toString(), tripScheduleDto.getTripDate());
        }
        throw exception(EntityType.USER, ExceptionType.ENTITY_NOT_FOUND, userDto.getEmail());
    }
